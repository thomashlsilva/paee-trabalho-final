...
# create symmetric matrix of distances
adj_mat = np.array(pd.read_csv('data/pa561.txt', header=None, sep=' '))
n = len(adj_mat)
...
opt_cost = 2763 # pa561
#opt_cost = 48450 # si535
#opt_cost = 92650 # si1032
